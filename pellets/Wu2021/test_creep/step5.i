...
pellet_nu = 0.345
pellet_specific_heat=90 # J/(kg·K)
...
# petsc_options_value = 'bjacobi  gmres     NONZERO        1e-10'
  ...
  # solve_type = 'NEWTON'  # 重用预处理器和矩阵排序
  # petsc_options = '-pc_factor_reuse_ordering -pc_factor_reuse_fill'
  
  # petsc_options_iname = '-pc_type -pc_factor_mat_solver_package -ksp_type -pc_factor_levels'
  # petsc_options_value = 'lu       mumps                        preonly   1'
