...
n_elems_azimuthal = 98 # 周向网格数
n_elems_radial_clad = 3 # 包壳径向网格数
n_elems_radial_pellet = 18 # 芯块径向网格数
...
# pellet_specific_heat=88 # J/(kg·K)
...
[Outputs]
  ...
  file_base = 'outputs/PF1_creep/h=${h}_l=${length_scale_paramete}_Gc=${pellet_critical_energy}'
[]
