...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step4.3.2_PF4d_Threshold'
...
parameter_matrix = {
    'grid_sizes': [6e-5],
    # 'length_scale_paramete': [3e-5],
    'Gc': [3,2.5,2,1.5],
    'grain_size': [10,8,6,12],
}
