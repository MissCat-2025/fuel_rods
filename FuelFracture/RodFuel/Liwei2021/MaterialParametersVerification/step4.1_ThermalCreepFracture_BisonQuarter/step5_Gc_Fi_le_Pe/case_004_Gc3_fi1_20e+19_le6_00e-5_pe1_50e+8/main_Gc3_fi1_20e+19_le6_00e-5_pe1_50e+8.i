...
# length_scale_paramet: 6.00e-5
# pellet_critical_fracture_strength: 1.50e+8
# 生成时间: 2025-04-03 16:50:16
...
Gc = 3 #断裂能
pellet_critical_fracture_strength = 1.50e+8#Pa
length_scale_paramete=2e-5
grid_sizes = 7e-5 #mm,最大网格尺寸
fission_rate = 1.20e+19
power_factor_mod = 1.4
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_Gc3_fi1_20e+19_le6_00e-5_pe1_50e+8.i'
...
[Functions]
  ...
  [dt_limit_func]
    type = ParsedFunction
    expression = 'if(t < 35000, 10000,
                   if(t < 100000, 2000,
                   if(t < 125000, 2000,
                   if(t < 175000, 4000,2000))))'
  []
[]
