...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step4.1_ThermalCreepFracture_BisonQuarter'
...
parameter_matrix = {
    'Gc': [1.5,2,3],
    'length_scale_paramete': [1e-5,2e-5,3e-5,4e-5,5e-5,6e-5],
}
