...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step4.3.3_PF4d_MoreCreep'
...
parameter_matrix = {
    'grid_sizes': [6e-5],
    # 'length_scale_paramete': [3.5e-5,4e-5,4.5e-5],
    'fission_rate': [1.2e19,1.5e19,2.0e19,3.0e19],
    'grain_size': [10],
}
