...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step4.3.4_Softening'
...
# 参数矩阵定义 (在此修改需要研究的参数)
parameter_matrix = {
    'grid_sizes': [6e-5,5.5e-5],
    'length_scale_paramete': [2e-5,3e-5,4e-5],
    'Gc': [1.5,2,2.5],
    # 'fission_rate': [1.2e19],
}
