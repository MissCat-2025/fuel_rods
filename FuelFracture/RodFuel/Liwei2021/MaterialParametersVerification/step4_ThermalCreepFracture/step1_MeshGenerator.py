...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step4_ThermalCreepFracture'
...
parameter_matrix = {
    'Gf': [1,2,3],
    'length_scale_paramete': [1.5e-5,2e-5,2.5e-5],
