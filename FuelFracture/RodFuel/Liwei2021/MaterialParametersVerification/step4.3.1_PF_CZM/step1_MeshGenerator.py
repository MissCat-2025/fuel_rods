...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step4.3.1_PF_CZM'
...
parameter_matrix = {
    'grid_sizes': [5e-5],
    'length_scale_paramete': [2e-5,1.5e-5,2.5e-5],
