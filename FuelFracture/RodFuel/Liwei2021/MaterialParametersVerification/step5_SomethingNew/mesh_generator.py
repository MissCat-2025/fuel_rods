...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step5/MultiApp'
template_main = os.path.join(base_dir, 'NoClad3D_quarter_ThermalCreepFracture.i')
template_sub = os.path.join(base_dir, 'NoClad3D_quarter_ThermalCreepFracture_Sub.i')
output_dir = os.path.join(base_dir, 'parameter_studies')

# 参数矩阵定义 (在此修改需要研究的参数)
parameter_matrix = {
    'power_factor_mod': [1.5],# 添加新参数格式：'parameter_name': [value1, value2, ...]}
    'Gf': [1,3,10],
    'length_scale_paramete': [6e-5,4e-5,2e-5],
}
