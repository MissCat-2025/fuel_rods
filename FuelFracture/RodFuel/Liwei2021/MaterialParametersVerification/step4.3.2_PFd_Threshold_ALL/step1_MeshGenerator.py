...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step4.3.2_PFd_Threshold_ALL'
...
# 参数矩阵定义 (在此修改需要研究的参数)
parameter_matrix = {
    'grid_sizes': [5.5e-5,4e-5],
    'length_scale_paramete': [3.5e-5,4e-5],
    # 'fission_rate': [1.2e19,1.3e19],
}
