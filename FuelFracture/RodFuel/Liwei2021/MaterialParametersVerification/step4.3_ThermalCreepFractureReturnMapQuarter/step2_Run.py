...
# 路径配置
BASE_DIR = '/home/yp/projects/raccoon/FuelFracture/RodFuel/Liwei2021/MaterialParametersVerification/step4.3_ThermalCreepFractureReturnMapQuarter'  # 基础目录
OUTPUT_DIR = os.path.join(BASE_DIR, 'parameter_studies')           # 参数研究输出目录
MOOSE_APP = "/home/yp/projects/raccoon/raccoon-opt"               # MOOSE可执行文件路径

# 运行配置
MPI_PROCESSES = 13        # MPI进程数
