...
[MultiApps]
  [fracture]
    ...
    input_files = 'step4_AddCreep_sub_CZM.i'
...
[Outputs]
  ...
  file_base = 'outputs/PF_CZM_creep/h=${h}_l=${length_scale_paramete}_Gc=${pellet_critical_energy}'
[]
