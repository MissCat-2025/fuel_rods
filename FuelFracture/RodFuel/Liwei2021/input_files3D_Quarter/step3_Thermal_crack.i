...
n_elems_azimuthal = 80 # 周向网格数
n_elems_radial_clad = 3 # 包壳径向网格数
n_elems_radial_pellet = 17 # 芯块径向网格数
#下面的网格可以运行不错的结果，且无数值问题
# n_elems_azimuthal = 150 # 周向网格数
# n_elems_radial_clad = 4 # 包壳径向网格数
# n_elems_radial_pellet = 25 # 芯块径向网格数
...
[MultiApps]
  [fracture]
    ...
    input_files = 'step3_Thermal_crack_sub.i'
...
[Materials]
  ...
  # []
    ...
    [pellet_properties2]
      type = ADGenericConstantMaterial
      prop_names = 'K G l Gc E0 density specific_heat'
      prop_values = '${pellet_K} ${pellet_G} ${length_scale_paramete} ${pellet_critical_energy} ${pellet_elastic_constants} ${pellet_density} ${pellet_specific_heat}'
      output_properties = 'l Gc'
      outputs = exodus
      block = pellet
    []
...
[Outputs]
  ...
  file_base = 'outputs/PF1_no_creep/h=${h}_l=${length_scale_paramete}_Gc=${pellet_critical_energy}'
[]
