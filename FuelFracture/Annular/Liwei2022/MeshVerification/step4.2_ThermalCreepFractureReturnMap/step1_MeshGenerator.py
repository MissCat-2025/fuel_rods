...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/Annular/Liwei2022/MeshVerification/step4.2_ThermalCreepFractureReturnMap'
...
parameter_matrix = {
    # 'x2': [1.25],
    'length_scale_paramete': [2e-5,3e-5,4e-5,5e-5],
    'fission_rate': [2.5e19,3e19,3.5e19,5e19]
}
