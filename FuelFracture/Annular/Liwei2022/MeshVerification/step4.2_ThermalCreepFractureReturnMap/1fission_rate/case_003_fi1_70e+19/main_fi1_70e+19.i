# === 参数研究案例 ===
# end_time = 1.10e+6
# fission_rate: 1.70e+19
# 生成时间: 2025-04-01 11:46:48

#  conda activate moose
#  mpirun -n 13 /home/yp/projects/raccoon/raccoon-opt -i NoClad3D_ThermallFractureStaggered.i
...
[Transfers]
  ...
  [to_all]
    ...
    variable = 'psie_active psip_active sigma0_field a1'
    source_variable = 'psie_active psip_active sigma0_field a1'
  []
[]
...
[Materials]
    ...
    # # # # 蠕变相关
    [plasticity]
      type = SmallDeformationUO2CreepModel
    ...
    [power_law_hardening]
      ...
      yield_stress = 6.0e7
      exponent = 5
      reference_plastic_strain = 0.005
      phase_field = d
