...
# 基础配置
base_dir = '/home/yp/projects/raccoon/FuelFracture/Annular/Liwei2022/MeshVerification/step4.1_ThermalCreepFracture_no_psip'
...
parameter_matrix = {
    'Gc': [2,1],
    'fission_rate': [2.0e19,1.5e19,1.2e19]
}
