...
# 基础配置
base_dir = "/home/yp/projects/raccoon/FuelFracture/Annular/Liwei2022/MeshVerification/step5_ThermalCreepFracture_AllEigenstrain/MultiApp"
moose_app = "/home/yp/projects/raccoon/raccoon-opt"  # MOOSE可执行文件路径
mpi_processes = 10  # 根据集群配置调整
