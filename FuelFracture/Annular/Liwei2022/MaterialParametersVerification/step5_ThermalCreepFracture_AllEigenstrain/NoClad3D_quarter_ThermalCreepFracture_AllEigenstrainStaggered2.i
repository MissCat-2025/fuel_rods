...
[MultiApps]
  [fracture]
    ...
    input_files = 'NoClad3D_quarter_ThermalCreepFracture_AllEigenstrainStaggered_Sub2.i'
...
[Materials]
    ...
    [pellet_thermal_conductivity] #新加的！！！！！！！！！！！！！！！！！！！！！！
      ...
      expression = '(100/(7.5408 + 17.692*T/1000 + 3.6142*(T/1000)^2) + 6400/((T/1000)^2.5)*exp(-16.35/(T/1000)))*(1-0.01*d)'
      block = pellet
    []
    ...
    [densification_coef]
      ...
      expression = '0.0001 * (exp(-4.605 * (burnup*1) / (CD_factor * 0.006024)) - 1)/3'# 0.6024是5000MWd/tU的转换系数
      block = pellet
    []
        # 肿胀应变计算
