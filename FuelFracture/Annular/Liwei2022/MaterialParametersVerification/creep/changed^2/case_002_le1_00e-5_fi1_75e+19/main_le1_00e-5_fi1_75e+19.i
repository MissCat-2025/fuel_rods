# === 参数研究案例 ===
# end_time = 9.50e+6
# length_scale_paramete: 1.00e-5
# fission_rate: 1.75e+19
# 生成时间: 2025-03-25 00:08:35
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_le1_00e-5_fi1_75e+19.i'
...
[Materials]
    ...
    [pellet_specific_heat]
      ...
      coupled_variables = 'T x d'  # 需要在AuxVariables中定义Y变量
      expression = '(1-0.8*d)*(296.7 * 535.285^2 * exp(535.285/T))/(T^2 * (exp(535.285/T) - 1)^2) + 2.43e-2 * T + (x+2) * 8.745e7 * 1.577e5 * exp(-1.577e5/(8.314*T))/(2 * 8.314 * T^2)'
      block = pellet
    []
