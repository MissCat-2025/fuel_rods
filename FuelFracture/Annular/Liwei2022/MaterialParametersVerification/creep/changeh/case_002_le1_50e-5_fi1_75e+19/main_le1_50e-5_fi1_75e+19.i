# === 参数研究案例 ===
# end_time = 2.00e+6
# length_scale_paramete: 1.50e-5
# fission_rate: 1.75e+19
# 生成时间: 2025-03-25 11:15:27
...
length_scale_paramete = 1.50e-5
# a1 = '${fparse 1.5*pellet_elastic_constants*Gc/pellet_critical_fracture_strength/pellet_critical_fracture_strength/length_scale_paramete}' 
...
length = 6e-5                    # 轴向长度(m)
# 网格控制参数n_azimuthal = 768时网格尺寸为6.0e-5m,75\1600最大网格尺寸为2.9e-5m
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_le1_50e-5_fi1_75e+19.i'
...
[Materials]
  ...
  []
    ...
    [crack_geometric]
      ...
      property_name = alpha
      expression = 'd' #d裂纹还行，d^2不行，2*d-d^2完全不行？
      phase_field = d
      block = pellet
    []
    [pellet_elasticity]
