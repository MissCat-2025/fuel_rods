...
# 基础配置
base_dir = 'raccoon/FuelFracture/Annular/Liwei2022/MaterialParametersVerification/step5/MultiApp'
...
# 参数矩阵定义 (在此修改需要研究的参数)
parameter_matrix = {
    'fission_rate': [1.2e19,2.0e19],      # 杨氏模量 (Pa)    # 添加新参数格式：'parameter_name': [value1, value2, ...]}
}
