# mpirun -n 12 ../../../../../raccoon-opt -i NoClad3D_ThermalCreepFracture_AllEigenstrainStaggered.i
...
[MultiApps]
  [fracture]
    ...
    input_files = 'NoClad3D_ThermalCreepFracture_AllEigenstrainStaggered_SubApp.i'
...
[Materials]
    ...
    [densification_coef]
      ...
      expression = '0.001 * (exp(-4.605 * burnup / (CD_factor * 0.006024)) - 1)/3'# 0.6024是5000MWd/tU的转换系数
      block = pellet
    []
        # 肿胀应变计算
