...
// class SmallDeformationHBasedElasticityCopy : public SmallDeformationElasticityModel,
//                                           public DerivativeMaterialPropertyNameInterface
// {
// public:
//   static InputParameters validParams();
//   SmallDeformationHBasedElasticityCopy(const InputParameters & parameters);
