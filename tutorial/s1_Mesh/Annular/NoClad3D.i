...
#mpirun -n 10 /home/yp/projects/raccoon/raccoon-opt -i NoClad3D.i --mesh-only KAERI_HANARO_UpperRod1_NoClad3D.e
...
n_radial_pellet = 13          # 燃料径向单元数
n_azimuthal = 212           # 周向基础单元数
